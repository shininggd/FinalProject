...
<link rel="stylesheet" type="text/css" href="<%=application.getContextPath()%>/resources/css/board/noticeWriteForm.css">
...
<section id="main_section">
	...
	<form action="noticeWrite" id="nWrite_frm" method="post" enctype="multipart/data-form">
		...
		<input type="text" name="writer" id="writer" value="${member.id }" readonly="readonly">
